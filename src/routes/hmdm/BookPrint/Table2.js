...
export default class Table2 extends PureComponent{
  render() {
    const columns = [
      ...
      {
        title: intl.get('leida.sale.closeRecord.masterFixedAsset').d('资产号'),
        dataIndex: 'masterFixedAsset',
        align: 'center',
        width: 80,
      },
      {
        title: intl.get('leida.sale.closeRecord.masterFixedAssetDescription').d('资产描述'),
        dataIndex: 'masterFixedAssetDescription',
        align: 'center',
        width: 80,
      },
      {
